...
const ProfilePhotoSelector = ({ image, setImage }) => {
  ...
  const handleimagechange = (event) => {
    ...
    if (file) {
      ...
      //gebrate preview url from the file
    ...
    <div className="flex justify-center mb-6">
      ...
      {!image ? (
        ...
        <div className="relative">
          ...
          <button type="button" className="w-8 h-8 flex items-center justify-center bg-red-500 text-white absolute rounded-full -bottom-1 -right-1" onClick={handleremoveimage}>
            <LuTrash />
          </button>
        </div>
      )}
